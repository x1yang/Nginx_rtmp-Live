...
public:
    ...
    void setupUi(QWidget *XRtmpStreamerClass)
    {
        ...
        XRtmpStreamerClass->resize(587, 340);
...
"}"));
    ...
    void retranslateUi(QWidget *XRtmpStreamerClass)
    {
        ...
        outUrl->setText(QApplication::translate("XRtmpStreamerClass", "rtmp://192.168.161.128/live", Q_NULLPTR));
        ...
        face->insertItems(0, QStringList()
         << QApplication::translate("XRtmpStreamerClass", "\346\227\240\347\276\216\351\242\234", Q_NULLPTR)
